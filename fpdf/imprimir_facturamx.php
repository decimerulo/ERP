...
$lafila=mysql_fetch_array($resultado);
	...
	$pdf->Ln(15); //el primer bloque empieza en la linea 18
	$pdf->Cell(20);
	$pdf->Cell(10,5,$dia1,0,0,'L',1);
	$pdf->Cell(10,5,$mes1,0,0,'L',1);
	$pdf->Cell(10,5,$ano1,0,0,'L',1);
	$pdf->Ln(5);
...
//	$pdf->Cell(15,4,$ano1,0,0,'L',0);
	...
	while ($row=mysql_fetch_array($resultado2))
	{
	  ...
	  $cantidad1= number_format(mysql_result($resultado2,$lineas,"cantidad"));	  
	...
	$pdf->Cell(30,5,$lafila["fvendedor"],0,0,'L',0); //vendedorrrrrrrrrr		  
	...
	$pdf->SetY(100);	//ARRIBA Y ABAJO BLOQUE DE SUB TOTAL, IGV, TOTAL
	$pdf->Cell(90);  //POSICION IZQUIERDA DERECHA 
    $pdf->Cell(32,4,$importe4,0,0,'R',1); //POSICION DE COLUMNA SUBTOTAL SIN IGV
