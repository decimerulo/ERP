...
<table width="50%" border="0">
  ...
  <tr>
    <td><span class="Estilo3">DE FACTURA No.: <? echo $minimo?> A FACTURA No.: <? echo $maximo?></span></td>
  </tr>
  <tr>
    <td><span class="Estilo3">NETO: <? echo number_format($neto,2,".",",")?> + <? echo $ivaimp ?> % IGV: <? echo number_format($iva,2,".",",")?></span></td>
  </tr>
  <tr>
