...
//	$pdf->Cell(15,4,$ano1,0,0,'L',0);
	...
	$pdf->Cell(10);
	$pdf->Cell(10,4,$bbcodfactura,0,0,'L',0);
	//$pdf->Ln(14);	
	...
	$pdf->SetY(70);			
	$consulta2 = "Select * from eefactulinea where bbcodfactura='$bbcodfactura' order by numlinea";
	...
	$pdf->Cell(30,5,$lafila["vendedor"],0,0,'L',0); //vendedorrrrrrrrrr	  
	...
	$pdf->Cell(40,4,strtoupper($nw->toWords($decimales[0], "es") ." Y ".$decimales[1]."/100 Nuevos Soles"),0,0,'L',0);
      ...
      $pdf->Output($name=("Boleta Peru pequeña.pdf"),'I');
