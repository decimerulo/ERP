				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codprovincia" type="text" class="cajaPequena" NAME="codprovincia" maxlength="3" value="<? echo $codprovincia?>"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
						...
						<tr>
							<td>Nombre</td>
							<td><input id="nombreprovincia" name="nombreprovincia" type="text" class="cajaGrande" maxlength="20" value="<? echo $nombreprovincia?>"></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
					</table>
