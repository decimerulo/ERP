...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO factulineatmp (bbcodfactura,numlinea,codigo,codfamilia,cantidad,precio,importe,dcto) VALUES ('$bbcodfacturatmp','','$codarticulo','$codfamilia','$cantidad','$precio','$importe','$descuento')";
...
<?php
$sel_lineas="SELECT factulineatmp.*,articulos.*,familias.nombre as nombrefamilia FROM factulineatmp,articulos,familias WHERE factulineatmp.bbcodfactura='$bbcodfacturatmp' AND factulineatmp.codigo=articulos.codarticulo AND factulineatmp.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY factulineatmp.numlinea ASC";
...
for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) {
	...
	if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
			...
			<tr class="<? echo $fondolinea?>">
				...
				<td width="2%"><a href="javascript:eliminar_linea(<?php echo $bbcodfacturatmp?>,<?php echo $numlinea?>,<?php echo $importe ?>)"><img src="../img/eliminar.png" border="0"></a></td>
			</tr>
<? } 
