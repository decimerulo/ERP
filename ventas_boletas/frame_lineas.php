...
?>
		  ...
		  <div id="ztotales" align="center">
			<table width="100%" border=0 align="center" cellpadding=3 cellspacing=0 class="fuente8">
			  ...
			  <tr>
				<td class="busqueda"><b>&nbsp;</b></td>
				<td align="right"><div align="right">
			      <input class="cajaTotales" name="baseimpuestos" type="hidden" id="baseimpuestos" size="12" align="right" value="<? echo number_format($baseiva,2,".",",");?>" readonly> 
		        </div></td>
			  </tr>
			  <tr>
