	...
	<body onload=inicio()>
		...
		<div id="pagina">
			...
			<div id="zonaContenido">
				...
				<div id="tituloForm" class="header">NUEVA BOLETA </div>
				...
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					...
					<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="64%">
								<div style="margin:0 10px 6px 0; float:right;">&nbsp;  <input style="margin:0 0 0 5px;" name="remito" id="remito" type="hidden"></div>						
							</td>
						...
						<tr>
						    ...
						    <td width="27%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<? echo $hoy?>" readonly> <img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0"  onMouseOver="this.style.cursor='pointer'">
...
//MODIFICANDO LINEAS PARA BOLETAS 
		</script></td>

				            <td width="3%">&nbsp;</td>

                            <td width="64%"><input NAME="iva" type="hidden" class="cajaMinima" id="iva" size="5" maxlength="5" value="0" onChange="cambio_iva()"> &nbsp; <div style="margin:0 10px 6px 0; float:right;">N&deg; de Boleta <input name="numfactura2" id="numfactura" type="text"></div>
							</td>
